...
data_util.add_prerequisite("steam-power", "kr-basic-fluid-handling")
...
data_util.remove_recipe_unlock("steam-power", "pipe")
data_util.remove_recipe_unlock("steam-power", "pipe-to-ground")
data_util.remove_recipe_unlock("steam-power", "offshore-pump")
